...
int main(int argc, char *argv[]) {
    ...
    // 3x3 mean filter smoothing on color image
    ...
    for (int y = 0; y < height; y++) {
        for (int x = 0; x < width; x++) {
            ...
            // Iterate over 3x3 neighborhood with boundary checks
    ...
    printf("Smoothing completed in %.4f seconds\n", end - start);
